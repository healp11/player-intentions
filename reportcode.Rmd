...
#Run this code before knitting report
This code shapes all of the variables used in the report and saves the neccesary data files as .csv files into "data/..." in your repository. 
```{r}
library(devtools)
library(ggplot2)
library(tidyr)
