...
I then ran the three state models with the player's advantage variable as the second response variable. At the zero values of the covariates, three clear states can be seen. However with repeated running of these model the results are not repeatable.

The three state model would be useful for identifying the probability of the player hitting a winner or an error from and attacking, returning or a defenisve state. A large probability of hitting a winner from a defensive state may be an indicator of player risk taking. 
