...
```{r}
library(depmixS4)
t5.mod5 <- depmix(winner ~ 1, transition = ~ oppo.speed + start.x + start.y + p.start.position.x + p.start.position.base.dist + projected.ballmark.x,  data = fed_only, nstates = 2, family=multinomial("identity"))
t5.fm5 <- fit(t5.mod5)
summary(t5.fm5)
...
t6.mod10 <- depmix(winner ~ 1, transition = ~ oppo.avg.acceleraion, data = fed_only, nstates = 2, family=multinomial("identity"))
