...
#x variable p.start.position.x
cor.test(formula = ~ p.start.position.x + p.advantage,
         data = fed16_df)

cor.test(formula = ~ p.start.position.x + p.end.position.x,
         data = fed16_df)

cor.test(formula = ~ p.start.position.x + oppo.start.position.x,
         data = fed16_df)

cor.test(formula = ~ p.start.position.x + oppo.distance,
         data = fed16_df)

#x variable p.advantage
cor.test(formula = ~ p.advantage + p.end.position.x,
         data = fed16_df)

cor.test(formula = ~ p.advantage + oppo.start.position.x,
         data = fed16_df)

cor.test(formula = ~ p.advantage + oppo.distance,
         data = fed16_df)

#x variable p.end.position.x
cor.test(formula = ~ p.end.position.x + oppo.start.position.x,
         data = fed16_df)

cor.test(formula = ~ p.end.position.x + oppo.distance,
         data = fed16_df)

#x variable oppo.start.position.x
cor.test(formula = ~ oppo.start.position.x + oppo.distance,
         data = fed16_df)
```
