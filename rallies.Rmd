...
To run transition_reveal, a single column was created for the player's start & end postition  x coordinates, they are grouped by rally number and shot number and alternating between start and end. The same thing is done for the player's position y coordinates and for the opponent's position x and y coordinates. For animating the ball position, similar columns are created alternating between the  start position and the projected ballmark for both x and y coordinates.
