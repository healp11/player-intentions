...
##Visualisation
```{r player baseline/centre distance differentials}
...
```
```{r speed/acceleration differentials}
ggplot() + 
...
## Type 5: Simple Models with New Variables, Independent of Match Score/Situation
