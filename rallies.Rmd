...
#temporarily removing inversion of y axis 
```{r  }
...
#str(seventythree_df, list.len = ncol(seventythree_df))
...
```{r}
#fed16_df <- na.omit(fed16_df)
```
#Player/Ball Position rows
```{r  }
...
fed_only$lag.p.angle[is.na(fed_only$lag.p.angle)] <- 0
fed_only$lag.lag.speed.ratio[is.na(fed_only$lag.speed.ratio)] <- 0
```

```{r }
#shot types
dlb_pos <- filter(fed_pos, down.line.backhand == "TRUE")

dlb_df <- filter(fed16_df, down.line.backhand == "TRUE")

dlb_fedonly <- filter(fed_only, down.line.backhand == "TRUE")

iof_fedonly <- filter(fed_only, inside.out.forehand == "TRUE")

dlw_fedonly <- filter(fed_only, down.line.winner == "TRUE")
```
...
longral_df <- filter(fed_pos, final.shot >= 10)
```
```{r}
longest_df <- filter(fed_pos, final.shot == 17)
```
...
```{r}
check_df <- filter(fed_pos, rally.number == "9")
```
...
oppo.avg.speed
oppo.peak.speed
oppo.avg.acceleraion
oppo.peak.acceleration 
p.avg.speed
p.peak.speed
p.avg.acceleraion
p.peak.acceleration 
...
oppo.advantage
p.advantage
avg.player.speed.diff
peak.player.speed.diff
avg.player.acceleration.diff
peak.player.acceleration.diff
avg.player.speed.ratio
peak.player.speed.ratio
avg.player.acceleration.ratio
peak.player.acceleration.ratio
p.rally.side.change.count
oppo.rally.side.change.count
oppo.movement.angle.1
oppo.movement.angle.2
p.movement.angle.1
p.movement.angle.2
more?
...
t1.mod1 <- depmix(winner ~ 1, transition = ~ oppo.speed + ser1 + ser2 + start.x, data = fed_only, nstates = 2, family=multinomial("identity"))
t1.fm1 <- fit(t1.mod1)
...
```{r}
library(depmixS4)
t2.mod1 <- depmix(list(winner ~ 1, speed.ratio ~ 1), transition = ~ oppo.speed + ser1 + ser2 + start.x + o.angle + oppo.hit.x + lag.p.angle + lag.speed.ratio, data = fed_only, na.allow = TRUE , nstates = 2, family=list(multinomial("identity"), gaussian()))
t2.fm1<- fit(t2.mod1)
...
## Type 5: Simple Models with New Variables, Independent of Match Score/Situation. FOcusing on player and ball positions

##Type 5 Model 1

Response: winner, p.angle Covariates: oppo.speed,  start.x, p.start.position.x
```{r}
library(depmixS4)
t5.mod1 <- depmix(winner ~ 1, transition = ~ oppo.speed + start.x + p.start.position.x,  data = fed_only, nstates = 2, family=multinomial("identity"))
t5.fm1 <- fit(t5.mod1)
summary(t5.fm1)
```
...
Response: winner, p.angle Covariates: oppo.speed,  start.x, start.y, p.start.position.x, p.start.position.y
```{r}
library(depmixS4)
t5.mod2 <- depmix(winner ~ 1, transition = ~ oppo.speed +  start.x + start.y + p.start.position.x + p.start.position.y,  data = fed_only, nstates = 2, family=multinomial("identity"))
t5.fm2 <- fit(t5.mod2)
summary(t5.fm2)
...
Response: winner, p.angle Covariates: oppo.speed,  start.x, start.y,  p.end.position.x, p.end.position.y

end positions seem to decrease iterations
```{r}
library(depmixS4)
t5.mod3 <- depmix(winner ~ 1, transition = ~ oppo.speed +  start.x + start.y +  p.end.position.x + p.end.position.y,  data = fed_only, nstates = 2, family=multinomial("identity"))
t5.fm3 <- fit(t5.mod3)
summary(t5.fm3)
...
Response: winner, p.angle Covariates: oppo.speed,  start.x, start.y, p.start.position.x, p.start.position.y, projected.ballmark.x
```{r}
library(depmixS4)
t5.mod4 <- depmix(winner ~ 1, transition = ~ oppo.speed +  start.x + start.y + p.start.position.x + p.start.position.y + projected.ballmark.x ,  data = fed_only, nstates = 2, family=multinomial("identity"))
t5.fm4 <- fit(t5.mod4)
summary(t5.fm4)
...
Response: winner, p.angle Covariates: oppo.speed, start.x, p.start.position.x, projected.ballmark.x, p.start.position.base.dist
```{r}
library(depmixS4)
t5.mod5 <- depmix(winner ~ 1, transition = ~ p.advantage + p.movement.angle.1 ,  data = fed_only, nstates = 2, family=multinomial("identity"))
t5.fm5 <- fit(t5.mod5)
summary(t5.fm5)

```
#Type 6 Model 
Looking at variables individually to determine best fit. Looking for lowest log likelihood. 
...
t6.mod1 <- depmix(winner ~ 1, transition = ~ start.x, data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm1 <- fit(t6.mod1)
...
t6.mod2 <- depmix(winner ~ 1, transition = ~ start.y, data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm2 <- fit(t6.mod2)
...
t6.mod3 <- depmix(winner ~ 1, transition = ~ p.start.position.x, data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm3 <- fit(t6.mod3)
...
t6.mod4 <- depmix(winner ~ 1, transition = ~ p.start.position.y, data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm4 <- fit(t6.mod4)
...
t6.mod5 <- depmix(winner ~ 1, transition = ~ p.end.position.x, data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm5 <- fit(t6.mod5)
...
t6.mod6 <- depmix(winner ~ 1, transition = ~ p.end.position.y, data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm6 <- fit(t6.mod6)
...
t6.mod7 <- depmix(winner ~ 1, transition = ~ p.distance, data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm7 <- fit(t6.mod7)
...
t6.mod8 <- depmix(winner ~ 1, transition = ~ oppo.avg.speed, data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm8 <- fit(t6.mod8)
...
t6.mod9 <- depmix(winner ~ 1, transition = ~ oppo.peak.speed, data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm9 <- fit(t6.mod9)
...
#Type 6 model 10
oppo.avg.acceleration
```{r}
library(depmixS4)

t6.mod10 <- depmix(winner ~ 1, transition = ~ oppo.avg.acceleration, data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm10 <- fit(t6.mod10)
...
t6.mod11 <- depmix(winner ~ 1, transition = ~ oppo.peak.acceleration , data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm11 <- fit(t6.mod11)
...
t6.mod12 <- depmix(winner ~ 1, transition = ~ p.avg.speed , data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm12 <- fit(t6.mod12)
...
t6.mod13 <- depmix(winner ~ 1, transition = ~ p.peak.speed , data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm13 <- fit(t6.mod13)
...
t6.mod14 <- depmix(winner ~ 1, transition = ~ p.avg.acceleration , data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm14 <- fit(t6.mod14)
...
t6.mod15 <- depmix(winner ~ 1, transition = ~ p.peak.acceleration , data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm15 <- fit(t6.mod15)
...
t6.mod16 <- depmix(winner ~ 1, transition = ~ oppo.work , data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm16 <- fit(t6.mod16)
...
t6.mod17 <- depmix(winner ~ 1, transition = ~ p.work , data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm17 <- fit(t6.mod17)
...
t6.mod18 <- depmix(winner ~ 1, transition = ~ p.advantage, data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm18 <- fit(t6.mod18)
...
t6.mod19 <- depmix(winner ~ 1, transition = ~ avg.player.speed.diff, data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm19 <- fit(t6.mod19)
...
t6.mod20 <- depmix(winner ~ 1, transition = ~ peak.player.speed.diff, data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm20 <- fit(t6.mod20)
...
t6.mod21 <- depmix(winner ~ 1, transition = ~ avg.player.acceleration.diff, data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm21 <- fit(t6.mod21)
...
t6.mod22 <- depmix(winner ~ 1, transition = ~ peak.player.acceleration.diff, data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm22 <- fit(t6.mod22)
...
t6.mod23 <- depmix(winner ~ 1, transition = ~ avg.player.speed.ratio, data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm23 <- fit(t6.mod23)
...
t6.mod24 <- depmix(winner ~ 1, transition = ~ peak.player.speed.ratio, data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm24 <- fit(t6.mod24)
...
t6.mod25 <- depmix(winner ~ 1, transition = ~ avg.player.acceleration.ratio, data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm25 <- fit(t6.mod25)
...
t6.mod26 <- depmix(winner ~ 1, transition = ~peak.player.acceleration.ratio, data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm26 <- fit(t6.mod26)
...
t6.mod27 <- depmix(winner ~ 1, transition = ~ p.rally.side.change.count, data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm27 <- fit(t6.mod27)
...
t6.mod28 <- depmix(winner ~ 1, transition = ~ oppo.rally.side.change.count, data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm28 <- fit(t6.mod28)
...
t6.mod29 <- depmix(winner ~ 1, transition = ~ oppo.movement.angle.1, data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm29 <- fit(t6.mod29)
...
t6.mod30 <- depmix(winner ~ 1, transition = ~ oppo.movement.angle.2, data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm30 <- fit(t6.mod30)
...
t6.mod31 <- depmix(winner ~ 1, transition = ~ p.movement.angle.1, data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm31 <- fit(t6.mod31)
...
t6.mod32 <- depmix(winner ~ 1, transition = ~ p.movement.angle.2, data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm32 <- fit(t6.mod32)
...
t6.mod33 <- depmix(winner ~ 1, transition = ~ isserver, data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm33 <- fit(t6.mod33)
...
t6.mod34 <- depmix(winner ~ 1, transition = ~ speed.diff , data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm34 <- fit(t6.mod34)
...
t6.mod35 <- depmix(winner ~ 1, transition = ~ speed.diff , data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm35 <- fit(t6.mod35)
...
t6.mod36 <- depmix(winner ~ 1, transition = ~ speed1  , data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm36 <- fit(t6.mod36)
...
t6.mod37 <- depmix(winner ~ 1, transition = ~ o.angle   , data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm37 <- fit(t6.mod37)
...
t6.mod38 <- depmix(winner ~ 1, transition = ~ p.angle    , data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm38 <- fit(t6.mod38)
...
t6.mod39 <- depmix(winner ~ 1, transition = ~ lag.p.angle   , data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm39 <- fit(t6.mod39)
...
t6.mod40 <- depmix(winner ~ 1, transition = ~ lag.speed.ratio    , data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm40 <- fit(t6.mod40)
...
t6.mod41 <- depmix(winner ~ 1, transition = ~ oppo.hit   , data = fed_only, nstates = 2, family=multinomial("identity"))
...
```{r}
for(i in colnames(fed_only))
{
  t6.mod41 <- depmix(winner ~ 1, transition = ~ i   , data = fed_only, nstates = 2, family=multinomial("identity"))
t6.fm41<- fit(t6.mod41)
