...
insert_df <- transform(fed16_df, p.start.position.x=lag.p.end.position.x, p.end.position.x=p.start.position.x,p.start.position.y=lag.p.end.position.y, p.end.position.y=p.start.position.y, oppo.start.position.x=lag.oppo.end.position.x, oppo.end.position.x=oppo.start.position.x,oppo.start.position.y=lag.oppo.end.position.y, oppo.end.position.y=oppo.start.position.y)
