...
Training Model 1 is the best combination of variables found from running stepwise on Data Set 1
```{r}
library(dplyr)
...
Data Set 2
Training Model two is the best combination of variables from running Stepwise on Data Set 2
...
##Stepwise Analysis
All Chunks for Stepwise have been Commented to running time/size of the file for Knit.
