...
```
p.start.position.x-
When compared to similar start position x coordinates, Federer appears more likely to hit a winner as he starts the shot closer to the net. This variable has been chosen for the HMM as we might expect that the probability of Federer being in an attacking state increases as he moves closer to the net 
...
When compared to similar start position x coordinates for Berdych, Federer appears more likely to hit a winner as Berdych starts the shot closer to the net.
...
p.movement.angle.2
```{r}
#Correlated with movement angle 1
```
