...
fed16_only$p.start.x[is.na(fed16_only$p.start.x)] <- 0
fed16_only$p.start.y[is.na(fed16_only$p.start.y)] <- 0
```
...
```{r}
library(depmixS4)
t5.mod1 <- depmix(winner ~ 1, transition = ~ oppo.speed + start.x + p.start.position.x,  data = fed16_only, nstates = 2, family=multinomial("identity"))
t5.fm1 <- fit(t5.mod1)
summary(t5.fm1)
```
...
```{r}
library(depmixS4)
t5.mod2 <- depmix(winner ~ 1, transition = ~ oppo.speed +  start.x + start.y + p.start.position.x + p.start.position.y,  data = fed16_only, nstates = 2, family=multinomial("identity"))
t5.fm2 <- fit(t5.mod2)
summary(t5.fm2)
...
```{r}
library(depmixS4)
t5.mod3 <- depmix(winner ~ 1, transition = ~ oppo.speed +  start.x + start.y +  p.end.position.x + p.end.position.y,  data = fed16_only, nstates = 2, family=multinomial("identity"))
t5.fm3 <- fit(t5.mod3)
summary(t5.fm3)
...
```{r}
library(depmixS4)
t5.mod4 <- depmix(winner ~ 1, transition = ~ oppo.speed +  start.x + start.y + p.start.position.x + p.start.position.y + projected.ballmark.x ,  data = fed16_only, nstates = 2, family=multinomial("identity"))
t5.fm4 <- fit(t5.mod4)
summary(t5.fm4)
...
```{r}
library(depmixS4)
t5.mod5 <- depmix(winner ~ 1, transition = ~ p.advantage + p.movement.angle.1 ,  data = fed16_only, nstates = 2, family=multinomial("identity"))
t5.fm5 <- fit(t5.mod5)
summary(t5.fm5)
...
t6.mod1 <- depmix(winner ~ 1, transition = ~ start.x, data = fed16_only, nstates = 2, family=multinomial("identity"))
t6.fm1 <- fit(t6.mod1)
...
t6.mod2 <- depmix(winner ~ 1, transition = ~ start.y, data = fed16_only, nstates = 2, family=multinomial("identity"))
t6.fm2 <- fit(t6.mod2)
...
t6.mod3 <- depmix(winner ~ 1, transition = ~ p.start.position.x, data = fed16_only, nstates = 2, family=multinomial("identity"))
t6.fm3 <- fit(t6.mod3)
...
t6.mod4 <- depmix(winner ~ 1, transition = ~ p.start.position.y, data = fed16_only, nstates = 2, family=multinomial("identity"))
t6.fm4 <- fit(t6.mod4)
...
t6.mod5 <- depmix(winner ~ 1, transition = ~ p.end.position.x, data = fed16_only, nstates = 2, family=multinomial("identity"))
t6.fm5 <- fit(t6.mod5)
...
t6.mod6 <- depmix(winner ~ 1, transition = ~ p.end.position.y, data = fed16_only, nstates = 2, family=multinomial("identity"))
t6.fm6 <- fit(t6.mod6)
...
t6.mod7 <- depmix(winner ~ 1, transition = ~ p.distance, data = fed16_only, nstates = 2, family=multinomial("identity"))
t6.fm7 <- fit(t6.mod7)
...
t6.mod8 <- depmix(winner ~ 1, transition = ~ oppo.avg.speed, data = fed16_only, nstates = 2, family=multinomial("identity"))
t6.fm8 <- fit(t6.mod8)
...
t6.mod9 <- depmix(winner ~ 1, transition = ~ oppo.peak.speed, data = fed16_only, nstates = 2, family=multinomial("identity"))
t6.fm9 <- fit(t6.mod9)
...
t6.mod10 <- depmix(winner ~ 1, transition = ~ oppo.avg.acceleration, data = fed16_only, nstates = 2, family=multinomial("identity"))
...
t6.mod11 <- depmix(winner ~ 1, transition = ~ oppo.peak.acceleration , data = fed16_only, nstates = 2, family=multinomial("identity"))
...
t6.mod12 <- depmix(winner ~ 1, transition = ~ p.avg.speed , data = fed16_only, nstates = 2, family=multinomial("identity"))
...
t6.mod13 <- depmix(winner ~ 1, transition = ~ p.peak.speed , data = fed16_only, nstates = 2, family=multinomial("identity"))
...
t6.mod14 <- depmix(winner ~ 1, transition = ~ p.avg.acceleration , data = fed16_only, nstates = 2, family=multinomial("identity"))
...
t6.mod15 <- depmix(winner ~ 1, transition = ~ p.peak.acceleration , data = fed16_only, nstates = 2, family=multinomial("identity"))
...
t6.mod16 <- depmix(winner ~ 1, transition = ~ oppo.work , data = fed16_only, nstates = 2, family=multinomial("identity"))
...
t6.mod17 <- depmix(winner ~ 1, transition = ~ p.work , data = fed16_only, nstates = 2, family=multinomial("identity"))
...
t6.mod18 <- depmix(winner ~ 1, transition = ~ p.advantage, data = fed16_only, nstates = 2, family=multinomial("identity"))
...
t6.mod19 <- depmix(winner ~ 1, transition = ~ avg.player.speed.diff, data = fed16_only, nstates = 2, family=multinomial("identity"))
...
t6.mod20 <- depmix(winner ~ 1, transition = ~ peak.player.speed.diff, data = fed16_only, nstates = 2, family=multinomial("identity"))
...
t6.mod21 <- depmix(winner ~ 1, transition = ~ avg.player.acceleration.diff, data = fed16_only, nstates = 2, family=multinomial("identity"))
...
t6.mod22 <- depmix(winner ~ 1, transition = ~ peak.player.acceleration.diff, data = fed16_only, nstates = 2, family=multinomial("identity"))
...
t6.mod23 <- depmix(winner ~ 1, transition = ~ avg.player.speed.ratio, data = fed16_only, nstates = 2, family=multinomial("identity"))
...
t6.mod24 <- depmix(winner ~ 1, transition = ~ peak.player.speed.ratio, data = fed16_only, nstates = 2, family=multinomial("identity"))
...
t6.mod25 <- depmix(winner ~ 1, transition = ~ avg.player.acceleration.ratio, data = fed16_only, nstates = 2, family=multinomial("identity"))
...
t6.mod26 <- depmix(winner ~ 1, transition = ~peak.player.acceleration.ratio, data = fed16_only, nstates = 2, family=multinomial("identity"))
...
t6.mod27 <- depmix(winner ~ 1, transition = ~ p.rally.side.change.count, data = fed16_only, nstates = 2, family=multinomial("identity"))
...
t6.mod28 <- depmix(winner ~ 1, transition = ~ oppo.rally.side.change.count, data = fed16_only, nstates = 2, family=multinomial("identity"))
...
t6.mod29 <- depmix(winner ~ 1, transition = ~ oppo.movement.angle.1, data = fed16_only, nstates = 2, family=multinomial("identity"))
...
t6.mod30 <- depmix(winner ~ 1, transition = ~ oppo.movement.angle.2, data = fed16_only, nstates = 2, family=multinomial("identity"))
...
t6.mod31 <- depmix(winner ~ 1, transition = ~ p.movement.angle.1, data = fed16_only, nstates = 2, family=multinomial("identity"))
...
t6.mod32 <- depmix(winner ~ 1, transition = ~ p.movement.angle.2, data = fed16_only, nstates = 2, family=multinomial("identity"))
...
t6.mod33 <- depmix(winner ~ 1, transition = ~ isserver, data = fed16_only, nstates = 2, family=multinomial("identity"))
...
t6.mod34 <- depmix(winner ~ 1, transition = ~ speed.diff , data = fed16_only, nstates = 2, family=multinomial("identity"))
...
t6.mod35 <- depmix(winner ~ 1, transition = ~ speed.diff , data = fed16_only, nstates = 2, family=multinomial("identity"))
...
t6.mod36 <- depmix(winner ~ 1, transition = ~ speed1  , data = fed16_only, nstates = 2, family=multinomial("identity"))
...
t6.mod37 <- depmix(winner ~ 1, transition = ~ o.angle   , data = fed16_only, nstates = 2, family=multinomial("identity"))
...
t6.mod38 <- depmix(winner ~ 1, transition = ~ p.angle    , data = fed16_only, nstates = 2, family=multinomial("identity"))
...
t6.mod39 <- depmix(winner ~ 1, transition = ~ lag.p.angle   , data = fed16_only, nstates = 2, family=multinomial("identity"))
...
t6.mod40 <- depmix(winner ~ 1, transition = ~ lag.speed.ratio    , data = fed16_only, nstates = 2, family=multinomial("identity"))
