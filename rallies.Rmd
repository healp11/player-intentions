...
fed16_df <- fed16_df %>%
  mutate(speed.diff = NA) %>%
  mutate(oppo.start.server.x = NA) %>%
  mutate(oppo.start.server.y = NA) %>%
  mutate(oppo.end.server.x = NA) %>%
  mutate(oppo.end.server.y = NA) %>%
  mutate(oppo.start.receiver.x = NA) %>%
  mutate(oppo.start.receiver.y = NA) %>%
  mutate(oppo.end.receiver.x = NA) %>%
  mutate(oppo.end.receiver.y = NA) %>%
  mutate(oppo.server.distance = NA) %>%
  mutate(oppo.receiver.distance = NA) %>%
  ...
  mutate(oppo.avg.server.speed = NA) %>%
  mutate(oppo.peak.server.speed = NA) %>%
  mutate(oppo.avg.receiver.speed = NA) %>%
  mutate(oppo.peak.receiver.speed = NA) %>%
  mutate(oppo.avg.server.acceleration = NA) %>%
  mutate(oppo.peak.server.acceleration = NA) %>%
  mutate(oppo.avg.receiver.acceleration = NA) %>%
  mutate(oppo.peak.receiver.acceleration = NA) 
