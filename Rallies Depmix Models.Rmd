...
fed_scale <- fed_scale %>%
  mutate(p.advantage.states = ifelse(p.advantage <= (-1000), 1,
                                     ifelse(p.advantage >= 1000,3,1))) %>%
