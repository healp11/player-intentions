...
library(GGally)
p1 <- ggduo(fm1_df, 1:3, 13, showStrips = FALSE)
p2 <- ggduo(fm1_df, 4:6, 13, showStrips = FALSE)
p3<- ggduo(fm1_df, 7:9, 13, showStrips = FALSE)
p4<- ggduo(fm1_df, 10:11, 13, showStrips = FALSE)
...
corfm1 <- cor(fm1_df)
corfm1_df <- as.data.frame(apply(corfm1, 2, function(x) ifelse (abs(x) >=0-1,x,"NA")))
corfm1_df <- corfm1_df[ -c(1:12) ]
...
#choosing variables of interest
fed_dep <- fed_only[, c("p.start.position.x", "p.start.position.y", "oppo.start.position.x", "oppo.start.position.y", "p.movement.angle.1", "p.start.shot.x", "lag.p.angle", "oppo.rally.side.change.count", "p.diff.avg.shot.and.match.movement.speed",  "oppo.diff.avg.shot.and.match.movement.speed", "diff.p.avg.and.current.shot.speed", "lag.diff.oppo.avg.and.current.shot.speed", "lag.oppo.height.off.net")]
...
```{r}
#scaling variables from 0 min to 1 max for comparison to hidden states plot
fed_scale <- fed_only[, c(  "p.start.position.x", "p.start.position.y", "oppo.start.position.x", "oppo.start.position.y", "p.movement.angle.1", "p.start.shot.x", "lag.p.angle", "oppo.rally.side.change.count", "p.diff.avg.shot.and.match.movement.speed",  "oppo.diff.avg.shot.and.match.movement.speed", "diff.p.avg.and.current.shot.speed", "lag.diff.oppo.avg.and.current.shot.speed", "lag.oppo.height.off.net")]

#error in scaling as two variables not created correcctly in rallies2
fed_scale <- as.data.frame(lapply(fed_dep[c( "p.start.position.x", "p.start.position.y", "oppo.start.position.x", "oppo.start.position.y", "p.movement.angle.1", "p.start.shot.x", "lag.p.angle", "oppo.rally.side.change.count", "p.diff.avg.shot.and.match.movement.speed",  "oppo.diff.avg.shot.and.match.movement.speed", "diff.p.avg.and.current.shot.speed", "lag.diff.oppo.avg.and.current.shot.speed", "lag.oppo.height.off.net")], function(y) (y-min(y))/(max(y)-min(y))))
...
# Variables fitted:
#p.start.position.x, oppo.start.position.x, oppo.diff.avg.shot.and.match.movement.speed, p.diff.avg.shot.and.match.movement.speed, lag.p.angle, oppo.rally.side.change.count, lag.diff.oppo.avg.and.current.shot.speed, diff.p.avg.and.current.shot.speed, p.movement.angle.1, lag.oppo.height.off.net, oppo.start.position.y
 tm.1 <- depmix(winner ~ 1, transition = ~ p.start.position.x + oppo.start.position.x + oppo.diff.avg.shot.and.match.movement.speed + p.diff.avg.shot.and.match.movement.speed + lag.p.angle + oppo.rally.side.change.count + lag.diff.oppo.avg.and.current.shot.speed + diff.p.avg.and.current.shot.speed + p.movement.angle.1 + lag.oppo.height.off.net + oppo.start.position.y, data = fed_scale, nstates = 2, family=multinomial("identity"))
 ftm.1 <- fit(tm.1)
...
#plotting a matrix to identify any correlation between depmix probabilities and chosen variables
library(GGally)
p5 <- ggduo(ftm.1_df, 1:3, 15, showStrips = FALSE)
p6 <- ggduo(ftm.1_df, 4:6, 15, showStrips = FALSE)
p7 <- ggduo(ftm.1_df, 7:9, 15, showStrips = FALSE)
p8 <- ggduo(ftm.1_df, 10:11, 15, showStrips = FALSE)
```
```{r}
#showing correlation between variables and probaility of being in state 1
...
corftm.1_df <- corftm.1_df[ -c(1:13) ]
...
#p.movement.angle.1, oppo.diff.avg.shot.and.match.movement.speed, p.start.shot.x, lag.p.angle, diff.p.avg.and.current.shot.speed, p.start.position.y, lag.oppo.height.off.net, oppo.rally.side.change.count, oppo.start.position.y, lag.diff.oppo.avg.and.current.shot.speed

#running this model on the scaled fed_only data set
tm.2 <- depmix(winner ~ 1, transition = ~ p.movement.angle.1 + oppo.diff.avg.shot.and.match.movement.speed + p.start.shot.x + lag.p.angle + diff.p.avg.and.current.shot.speed + p.start.position.y + lag.oppo.height.off.net + oppo.rally.side.change.count + oppo.start.position.y + lag.diff.oppo.avg.and.current.shot.speed, data = fed_scale, nstates = 2, family=multinomial("identity"))
 ftm.2 <- fit(tm.2)
...
#plotting a matrix to identify any correlation between depmix probabilities and chosen variables
library(GGally)
p9 <- ggduo(ftm.2_df, 1:3, 13, showStrips = FALSE)
p10 <- ggduo(ftm.2_df, 4:6, 13, showStrips = FALSE)
p11 <- ggduo(ftm.2_df, 7:9, 13, showStrips = FALSE)
p12 <- ggduo(ftm.2_df, 10, 13, showStrips = FALSE)
```
...
corftm.2_df <- corftm.2_df[ -c(1:12) ]
```

#Saving output for presentation

```{r}
#Prob plots for training model 1
png(filename="plot1.jpeg")
print(p1)
dev.off()

png(filename="plot2.jpeg")
print(p2)
dev.off()

png(filename="plot3.jpeg")
print(p3)
dev.off()

png(filename="plot4.jpeg")
print(p4)
dev.off()

#plots for test model 1
png(filename="plot5.jpeg")
print(p5)
dev.off()

png(filename="plot6.jpeg")
print(p6)
dev.off()

png(filename="plot7.jpeg")
print(p7)
dev.off()

png(filename="plot8.jpeg")
print(p8)
dev.off()

#Plots for test model 2
png(filename="plot9.jpeg")
print(p5)
dev.off()

png(filename="plot10.jpeg")
print(p6)
dev.off()

png(filename="plot11.jpeg")
print(p7)
dev.off()

png(filename="plot12.jpeg")
print(p8)
dev.off()
...
```
#Running stepwise for test model 1 Federer 16/17/18

```{r}
#run through all variables to find highest log lik
#tm1.fcov1 is test model 1 fitted covariates 1
tm1.fcov1 <- lapply(fed_scale[c( "p.start.position.x", "p.start.position.y", "oppo.start.position.x", "oppo.start.position.y", "p.movement.angle.1", "p.start.shot.x", "lag.p.angle", "oppo.rally.side.change.count", "p.diff.avg.shot.and.match.movement.speed",  "oppo.diff.avg.shot.and.match.movement.speed", "diff.p.avg.and.current.shot.speed", "lag.diff.oppo.avg.and.current.shot.speed", "lag.oppo.height.off.net")], function(w) fit((depmix(winner ~ 1, data = fed_scale, transition = ~ w, nstates = 2, family=multinomial("identity"))), verbose = FALSE, emc=em.control(rand=TRUE)))
...
tm1.fcov1_df <-  as.data.frame(
  c(logLik(tm1.fcov1$p.start.position.x), logLik(tm1.fcov1$p.start.position.y),
    ...
    logLik(tm1.fcov1$p.movement.angle.1),logLik(tm1.fcov1$p.start.shot.x),
    logLik(tm1.fcov1$lag.p.angle),
    ...
    logLik(tm1.fcov1$diff.p.avg.and.current.shot.speed),
    logLik(tm1.fcov1$lag.diff.oppo.avg.and.current.shot.speed), logLik(tm1.fcov1$lag.oppo.height.off.net)  )
  )

tm1.fcov1_df$newcolumn<-c( "p.start.position.x", "p.start.position.y", "oppo.start.position.x", "oppo.start.position.y", "p.movement.angle.1", "p.start.shot.x", "lag.p.angle", "oppo.rally.side.change.count", "p.diff.avg.shot.and.match.movement.speed",  "oppo.diff.avg.shot.and.match.movement.speed", "diff.p.avg.and.current.shot.speed", "lag.diff.oppo.avg.and.current.shot.speed", "lag.oppo.height.off.net")
...
#run through all variables to find highest log lik
tm1.fcov2 <- lapply(fed_scale[c( "p.start.position.x", "p.start.position.y", "oppo.start.position.x", "oppo.start.position.y", "p.start.shot.x", "lag.p.angle", "oppo.rally.side.change.count", "p.diff.avg.shot.and.match.movement.speed",  "oppo.diff.avg.shot.and.match.movement.speed", "diff.p.avg.and.current.shot.speed", "lag.diff.oppo.avg.and.current.shot.speed", "lag.oppo.height.off.net")], function(w) fit((depmix(winner ~ 1, data = fed_scale, transition = ~ p.movement.angle.1 + w, nstates = 2, family=multinomial("identity"))), verbose = FALSE, emc=em.control(rand=TRUE)))


#Pulling covergence log likelihoods into a dataframe
tm1.fcov2_df <-  as.data.frame(
  c(logLik(tm1.fcov2$p.start.position.x), logLik(tm1.fcov2$p.start.position.y),
    logLik(tm1.fcov2$oppo.start.position.x), logLik(tm1.fcov2$oppo.start.position.y), logLik(tm1.fcov2$p.start.shot.x),
    logLik(tm1.fcov2$lag.p.angle),
    ...
    logLik(tm1.fcov2$diff.p.avg.and.current.shot.speed),
    logLik(tm1.fcov2$lag.diff.oppo.avg.and.current.shot.speed), logLik(tm1.fcov2$lag.oppo.height.off.net)  )
  )

tm1.fcov2_df$newcolumn<-c( "p.start.position.x", "p.start.position.y", "oppo.start.position.x", "oppo.start.position.y", "p.start.shot.x", "lag.p.angle", "oppo.rally.side.change.count", "p.diff.avg.shot.and.match.movement.speed",  "oppo.diff.avg.shot.and.match.movement.speed", "diff.p.avg.and.current.shot.speed", "lag.diff.oppo.avg.and.current.shot.speed", "lag.oppo.height.off.net")
...
#run through all variables to find highest log lik
tm1.fcov3 <- lapply(fed_scale[c( "p.start.position.x", "p.start.position.y", "oppo.start.position.x", "oppo.start.position.y", "p.start.shot.x", "lag.p.angle", "oppo.rally.side.change.count", "p.diff.avg.shot.and.match.movement.speed", "diff.p.avg.and.current.shot.speed", "lag.diff.oppo.avg.and.current.shot.speed", "lag.oppo.height.off.net")], function(w) fit((depmix(winner ~ 1, data = fed_scale, transition = ~ p.movement.angle.1 + oppo.diff.avg.shot.and.match.movement.speed + w, nstates = 2, family=multinomial("identity"))), verbose = FALSE, emc=em.control(rand=TRUE)))


#Pulling covergence log likelihoods into a dataframe
tm1.fcov3_df <-  as.data.frame(
  c(logLik(tm1.fcov3$p.start.position.x), logLik(tm1.fcov3$p.start.position.y),
    logLik(tm1.fcov3$oppo.start.position.x), logLik(tm1.fcov3$oppo.start.position.y), logLik(tm1.fcov3$p.start.shot.x),
    logLik(tm1.fcov3$lag.p.angle),
    logLik(tm1.fcov3$oppo.rally.side.change.count), logLik(tm1.fcov3$p.diff.avg.shot.and.match.movement.speed),
    logLik(tm1.fcov3$diff.p.avg.and.current.shot.speed),
    logLik(tm1.fcov3$lag.diff.oppo.avg.and.current.shot.speed), logLik(tm1.fcov3$lag.oppo.height.off.net)  )
  )

tm1.fcov3_df$newcolumn<-c( "p.start.position.x", "p.start.position.y", "oppo.start.position.x", "oppo.start.position.y", "p.start.shot.x", "lag.p.angle", "oppo.rally.side.change.count", "p.diff.avg.shot.and.match.movement.speed", "diff.p.avg.and.current.shot.speed", "lag.diff.oppo.avg.and.current.shot.speed", "lag.oppo.height.off.net")
...
```
```{r}
#third best variable is p.start.shot.x
#run through all variables to find highest log lik
tm1.fcov4 <- lapply(fed_scale[c( "p.start.position.x", "p.start.position.y", "oppo.start.position.x", "oppo.start.position.y", "lag.p.angle", "oppo.rally.side.change.count", "p.diff.avg.shot.and.match.movement.speed", "diff.p.avg.and.current.shot.speed", "lag.diff.oppo.avg.and.current.shot.speed", "lag.oppo.height.off.net")], function(w) fit((depmix(winner ~ 1, data = fed_scale, transition = ~ p.movement.angle.1 + oppo.diff.avg.shot.and.match.movement.speed + p.start.shot.x + w, nstates = 2, family=multinomial("identity"))), verbose = FALSE, emc=em.control(rand=TRUE)))


#Pulling covergence log likelihoods into a dataframe
tm1.fcov4_df <-  as.data.frame(
  c(logLik(tm1.fcov4$p.start.position.x), logLik(tm1.fcov4$p.start.position.y),
    logLik(tm1.fcov4$oppo.start.position.x), logLik(tm1.fcov4$oppo.start.position.y),
    logLik(tm1.fcov4$lag.p.angle),
    logLik(tm1.fcov4$oppo.rally.side.change.count), logLik(tm1.fcov4$p.diff.avg.shot.and.match.movement.speed),
    logLik(tm1.fcov4$diff.p.avg.and.current.shot.speed),
    logLik(tm1.fcov4$lag.diff.oppo.avg.and.current.shot.speed), logLik(tm1.fcov4$lag.oppo.height.off.net)  )
  )

tm1.fcov4_df$newcolumn<-c( "p.start.position.x", "p.start.position.y", "oppo.start.position.x", "oppo.start.position.y", "lag.p.angle", "oppo.rally.side.change.count", "p.diff.avg.shot.and.match.movement.speed", "diff.p.avg.and.current.shot.speed", "lag.diff.oppo.avg.and.current.shot.speed", "lag.oppo.height.off.net")
...
```
```{r}
#fourth best variable is lag.p.angle
#run through all variables to find highest log lik
...
tm1.fcov5_df <-  as.data.frame(
  c(logLik(tm1.fcov5$p.start.position.x), logLik(tm1.fcov5$p.start.position.y),
    ...
    logLik(tm1.fcov5$lag.diff.oppo.avg.and.current.shot.speed), logLik(tm1.fcov5$lag.oppo.height.off.net)  )
  )

tm1.fcov5_df$newcolumn<-c( "p.start.position.x", "p.start.position.y", "oppo.start.position.x", "oppo.start.position.y", "oppo.rally.side.change.count", "p.diff.avg.shot.and.match.movement.speed", "diff.p.avg.and.current.shot.speed", "lag.diff.oppo.avg.and.current.shot.speed", "lag.oppo.height.off.net")
...
tm1.fcov6_df <-  as.data.frame(
  c(logLik(tm1.fcov6$p.start.position.x), logLik(tm1.fcov6$p.start.position.y),
    ...
    logLik(tm1.fcov6$lag.diff.oppo.avg.and.current.shot.speed), logLik(tm1.fcov6$lag.oppo.height.off.net)  )
  )

tm1.fcov6_df$newcolumn<-c( "p.start.position.x", "p.start.position.y", "oppo.start.position.x", "oppo.start.position.y", "oppo.rally.side.change.count", "p.diff.avg.shot.and.match.movement.speed", "lag.diff.oppo.avg.and.current.shot.speed", "lag.oppo.height.off.net")
...
tm1.fcov7_df <-  as.data.frame(
  c(logLik(tm1.fcov7$p.start.position.x),
    ...
    logLik(tm1.fcov7$lag.diff.oppo.avg.and.current.shot.speed), logLik(tm1.fcov7$lag.oppo.height.off.net)  )
  )

tm1.fcov7_df$newcolumn<-c( "p.start.position.x", "oppo.start.position.x", "oppo.start.position.y", "oppo.rally.side.change.count", "p.diff.avg.shot.and.match.movement.speed", "lag.diff.oppo.avg.and.current.shot.speed", "lag.oppo.height.off.net")
...
#run through all variables to find highest log lik
tm1.fcov8 <- lapply(fed_scale[c( "p.start.position.x", "oppo.start.position.x", "oppo.start.position.y", "oppo.rally.side.change.count", "p.diff.avg.shot.and.match.movement.speed", "lag.diff.oppo.avg.and.current.shot.speed")], function(w) fit((depmix(winner ~ 1, data = fed_scale, transition = ~ p.movement.angle.1 + oppo.diff.avg.shot.and.match.movement.speed + p.start.shot.x + lag.p.angle + diff.p.avg.and.current.shot.speed + p.start.position.y + lag.oppo.height.off.net + w, nstates = 2, family=multinomial("identity"))), verbose = FALSE, emc=em.control(rand=TRUE)))
...
tm1.fcov8_df <-  as.data.frame(
  c(logLik(tm1.fcov8$p.start.position.x),
    ...
    logLik(tm1.fcov8$lag.diff.oppo.avg.and.current.shot.speed)  )
  )

tm1.fcov8_df$newcolumn<-c( "p.start.position.x", "oppo.start.position.x", "oppo.start.position.y", "oppo.rally.side.change.count", "p.diff.avg.shot.and.match.movement.speed", "lag.diff.oppo.avg.and.current.shot.speed")
...
#run through all variables to find highest log lik
tm1.fcov9 <- lapply(fed_scale[c( "p.start.position.x", "oppo.start.position.x", "oppo.start.position.y", "p.diff.avg.shot.and.match.movement.speed", "lag.diff.oppo.avg.and.current.shot.speed")], function(w) fit((depmix(winner ~ 1, data = fed_scale, transition = ~ p.movement.angle.1 + oppo.diff.avg.shot.and.match.movement.speed + p.start.shot.x + lag.p.angle + diff.p.avg.and.current.shot.speed + p.start.position.y + lag.oppo.height.off.net + oppo.rally.side.change.count + w, nstates = 2, family=multinomial("identity"))), verbose = FALSE, emc=em.control(rand=TRUE)))
...
tm1.fcov9_df <-  as.data.frame(
  c(logLik(tm1.fcov9$p.start.position.x),
    ...
    logLik(tm1.fcov9$lag.diff.oppo.avg.and.current.shot.speed)  )
  )

tm1.fcov9_df$newcolumn<-c( "p.start.position.x", "oppo.start.position.x", "oppo.start.position.y", "p.diff.avg.shot.and.match.movement.speed", "lag.diff.oppo.avg.and.current.shot.speed")
...
tm1.fcov10_df <-  as.data.frame(
  c(logLik(tm1.fcov10$p.start.position.x),
    ...
    logLik(tm1.fcov10$lag.diff.oppo.avg.and.current.shot.speed)  )
  )

tm1.fcov10_df$newcolumn<-c( "p.start.position.x", "oppo.start.position.x", "p.diff.avg.shot.and.match.movement.speed", "lag.diff.oppo.avg.and.current.shot.speed")
