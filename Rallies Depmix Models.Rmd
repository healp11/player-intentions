...
"lag.diff.oppo.avg.and.current.shot.speed":The difference in speed in m/s between the opponents last shot and their average shot speed during the match.
...
library(GGally)
ggduo(fm1_df, 1:3, 13, showStrips = FALSE)
ggduo(fm1_df, 4:6, 13, showStrips = FALSE)
ggduo(fm1_df, 7:9, 13, showStrips = FALSE)
ggduo(fm1_df, 10:11, 13, showStrips = FALSE)
