...
#plotting a matrix to identify any correlation between depmix probabilities and chosen variables
library(GGally)
ggduo(ftm.1_df, 1:3, 15, showStrips = FALSE)
ggduo(ftm.1_df, 4:6, 15, showStrips = FALSE)
ggduo(ftm.1_df, 7:9, 15, showStrips = FALSE)
ggduo(ftm.1_df, 10:11, 15, showStrips = FALSE)
```
```{r}
#showing correlation between variables and probaility of being in state 1
