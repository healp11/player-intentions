...
#p.start.position.x, oppo.start.position.x, oppo.diff.avg.shot.and.match.movement.speed, p.diff.avg.shot.and.match.movement.speed, oppo.start.position.y
 ds1.mod1.2s <- depmix(winner ~ 1, transition = ~ p.start.position.x + oppo.start.position.x + oppo.diff.avg.shot.and.match.movement.speed + p.diff.avg.shot.and.match.movement.speed + oppo.start.position.y, data = fed16_scale, nstates = 2, family=multinomial("identity"))
...
#dropping columns not in the fitted depmix model
 ...
 ds1.fm1.2s_df <- ds1.fm1.2s_df[ -c(2, 5:7, 10:14) ]
```
...
cor.ds1.fm1.2s_df <- cor.ds1.fm1.2s_df[ -c(1:5, 7) ]
...
#mod1.3s refers to model 1 with 3 states
 ds1.mod1.3s <- depmix(winner.return.error ~ 1, transition = ~ p.start.position.x + oppo.start.position.x + oppo.diff.avg.shot.and.match.movement.speed + p.diff.avg.shot.and.match.movement.speed + oppo.start.position.y, data = fed16_scale, nstates = 3, family=multinomial("identity"))
...
# Variables fitted:
#p.start.position.x, oppo.start.position.x, oppo.diff.avg.shot.and.match.movement.speed, p.diff.avg.shot.and.match.movement.speed, lag.p.angle, oppo.rally.side.change.count, diff.lag.oppo.avg.and.current.shot.speed, diff.p.avg.and.current.shot.speed, p.movement.angle.1, lag.oppo.height.off.net, oppo.start.position.y
 ds2.mod1.2s <- depmix(winner ~ 1, transition = ~ p.start.position.x + oppo.start.position.x + oppo.diff.avg.shot.and.match.movement.speed + p.diff.avg.shot.and.match.movement.speed + oppo.start.position.y, data = fed_scale, nstates = 2, family=multinomial("identity"))
...
ds2.mod2.2s <- depmix(winner ~ 1, transition = ~ p.movement.angle.1 + oppo.diff.avg.shot.and.match.movement.speed + p.start.position.y + oppo.rally.side.change.count , data = fed_scale, nstates = 2, family=multinomial("identity"))
...
```{r}
#running this model on the scaled fed_only data set
ds2.mod2.3s <- depmix(winner.return.error ~ 1, transition = ~ p.movement.angle.1 + oppo.diff.avg.shot.and.match.movement.speed + p.start.position.y + oppo.rally.side.change.count , data = fed_scale, nstates = 3, family=multinomial("identity"))
...
tm2.fcov1 <- lapply(fed_scale[c( "p.start.position.x", "p.start.position.y", "oppo.start.position.x", "oppo.start.position.y", "p.movement.angle.1", "oppo.rally.side.change.count", "p.diff.avg.shot.and.match.movement.speed",  "oppo.diff.avg.shot.and.match.movement.speed", "diff.p.avg.and.current.shot.speed",  "lag.oppo.height.off.net")], function(w) fit((depmix(winner ~ 1, data = fed_scale, transition = ~ w, nstates = 2, family=multinomial("identity"))), verbose = FALSE, emc=em.control(rand=TRUE)))
...
tm2.fcov1_df <-  as.data.frame(
  c(logLik(tm2.fcov1$p.start.position.x), logLik(tm2.fcov1$p.start.position.y),
    ...
    logLik(tm2.fcov1$oppo.rally.side.change.count), logLik(tm2.fcov1$p.diff.avg.shot.and.match.movement.speed),
    logLik(tm2.fcov1$oppo.diff.avg.shot.and.match.movement.speed),
    logLik(tm2.fcov1$diff.p.avg.and.current.shot.speed), logLik(tm2.fcov1$lag.oppo.height.off.net)  )
  )

tm2.fcov1_df$newcolumn<-c( "p.start.position.x", "p.start.position.y", "oppo.start.position.x", "oppo.start.position.y", "p.movement.angle.1","oppo.rally.side.change.count", "p.diff.avg.shot.and.match.movement.speed",  "oppo.diff.avg.shot.and.match.movement.speed", "diff.p.avg.and.current.shot.speed",  "lag.oppo.height.off.net")
...
#run through all variables to find highest log lik
tm2.fcov2 <- lapply(fed_scale[c( "p.start.position.x", "p.start.position.y", "oppo.start.position.x", "oppo.start.position.y", "oppo.rally.side.change.count", "p.diff.avg.shot.and.match.movement.speed",  "oppo.diff.avg.shot.and.match.movement.speed", "diff.p.avg.and.current.shot.speed",  "lag.oppo.height.off.net")], function(w) fit((depmix(winner ~ 1, data = fed_scale, transition = ~ p.movement.angle.1 + w, nstates = 2, family=multinomial("identity"))), verbose = FALSE, emc=em.control(rand=TRUE)))
...
tm2.fcov2_df <-  as.data.frame(
  c(logLik(tm2.fcov2$p.start.position.x), logLik(tm2.fcov2$p.start.position.y),
    ...
    logLik(tm2.fcov2$oppo.rally.side.change.count), logLik(tm2.fcov2$p.diff.avg.shot.and.match.movement.speed),
    logLik(tm2.fcov2$oppo.diff.avg.shot.and.match.movement.speed),
    logLik(tm2.fcov2$diff.p.avg.and.current.shot.speed), logLik(tm2.fcov2$lag.oppo.height.off.net)  )
  )

tm2.fcov2_df$newcolumn<-c( "p.start.position.x", "p.start.position.y", "oppo.start.position.x", "oppo.start.position.y", "oppo.rally.side.change.count", "p.diff.avg.shot.and.match.movement.speed",  "oppo.diff.avg.shot.and.match.movement.speed", "diff.p.avg.and.current.shot.speed",  "lag.oppo.height.off.net")
...
#run through all variables to find highest log lik
tm2.fcov3 <- lapply(fed_scale[c( "p.start.position.x", "p.start.position.y", "oppo.start.position.x", "oppo.start.position.y", "oppo.rally.side.change.count", "p.diff.avg.shot.and.match.movement.speed", "diff.p.avg.and.current.shot.speed",  "lag.oppo.height.off.net")], function(w) fit((depmix(winner ~ 1, data = fed_scale, transition = ~ p.movement.angle.1 + oppo.diff.avg.shot.and.match.movement.speed + w, nstates = 2, family=multinomial("identity"))), verbose = FALSE, emc=em.control(rand=TRUE)))
...
tm2.fcov3_df <-  as.data.frame(
  c(logLik(tm2.fcov3$p.start.position.x), logLik(tm2.fcov3$p.start.position.y),
    ...
    logLik(tm2.fcov3$oppo.rally.side.change.count), logLik(tm2.fcov3$p.diff.avg.shot.and.match.movement.speed),
    logLik(tm2.fcov3$diff.p.avg.and.current.shot.speed), logLik(tm2.fcov3$lag.oppo.height.off.net)  )
  )

tm2.fcov3_df$newcolumn<-c( "p.start.position.x", "p.start.position.y", "oppo.start.position.x", "oppo.start.position.y", "oppo.rally.side.change.count", "p.diff.avg.shot.and.match.movement.speed", "diff.p.avg.and.current.shot.speed",  "lag.oppo.height.off.net")
...
#run through all variables to find highest log lik
tm2.fcov4 <- lapply(fed_scale[c( "p.start.position.x", "p.start.position.y", "oppo.start.position.x", "oppo.start.position.y", "oppo.rally.side.change.count", "p.diff.avg.shot.and.match.movement.speed", "diff.p.avg.and.current.shot.speed",  "lag.oppo.height.off.net")], function(w) fit((depmix(winner ~ 1, data = fed_scale, transition = ~ p.movement.angle.1 + oppo.diff.avg.shot.and.match.movement.speed + p.start.position.y + w, nstates = 2, family=multinomial("identity"))), verbose = FALSE, emc=em.control(rand=TRUE)))
...
tm2.fcov4_df <-  as.data.frame(
  c(logLik(tm2.fcov4$p.start.position.x),
    ...
    logLik(tm2.fcov4$oppo.rally.side.change.count), logLik(tm2.fcov4$p.diff.avg.shot.and.match.movement.speed),
    logLik(tm2.fcov4$diff.p.avg.and.current.shot.speed), logLik(tm2.fcov4$lag.oppo.height.off.net)  )
  )

tm2.fcov4_df$newcolumn<-c( "p.start.position.x", "oppo.start.position.x", "oppo.start.position.y", "oppo.rally.side.change.count", "p.diff.avg.shot.and.match.movement.speed", "diff.p.avg.and.current.shot.speed",  "lag.oppo.height.off.net")
...
tm2.fcov5_df <-  as.data.frame(
  c(logLik(tm2.fcov5$p.start.position.x),
    logLik(tm2.fcov5$oppo.start.position.x), logLik(tm2.fcov5$oppo.start.position.y), logLik(tm2.fcov5$p.diff.avg.shot.and.match.movement.speed),
    logLik(tm2.fcov5$diff.p.avg.and.current.shot.speed), logLik(tm2.fcov5$lag.oppo.height.off.net)  )
  )

tm2.fcov5_df$newcolumn<-c( "p.start.position.x", "oppo.start.position.x", "oppo.start.position.y", "p.diff.avg.shot.and.match.movement.speed", "diff.p.avg.and.current.shot.speed",  "lag.oppo.height.off.net")
...
#choosing variables of interest
stry_dep <- stry_only[, c( "p.start.position.x", "p.start.position.y", "oppo.start.position.x", "oppo.start.position.y", "p.movement.angle.1", "p.start.shot.x",  "oppo.rally.side.change.count", "p.diff.avg.shot.and.match.movement.speed",  "oppo.diff.avg.shot.and.match.movement.speed", "diff.p.avg.and.current.shot.speed",  "lag.oppo.height.off.net", "winner.return.error")]
...
```{r}
#scaling variables from 0 min to 1 max for comparison to hidden states plot
stry_scale <- stry_only[, c(  "p.start.position.x", "p.start.position.y", "oppo.start.position.x", "oppo.start.position.y", "p.movement.angle.1", "p.start.shot.x",  "oppo.rally.side.change.count", "p.diff.avg.shot.and.match.movement.speed",  "oppo.diff.avg.shot.and.match.movement.speed", "diff.p.avg.and.current.shot.speed",  "lag.oppo.height.off.net", "winner.return.error")]

stry_scale <- as.data.frame(lapply(stry_dep[c( "p.start.position.x", "p.start.position.y", "oppo.start.position.x", "oppo.start.position.y", "p.movement.angle.1", "p.start.shot.x",  "oppo.rally.side.change.count", "p.diff.avg.shot.and.match.movement.speed",  "oppo.diff.avg.shot.and.match.movement.speed", "diff.p.avg.and.current.shot.speed",  "lag.oppo.height.off.net", "winner.return.error")], function(x) (x-min(x))/(max(x)-min(x))))
#adding winner and total shot number to the df for analysis
...
```{r}
ds3.mod2.3s <- depmix(winner.return.error ~ 1, transition = ~ p.movement.angle.1 + oppo.diff.avg.shot.and.match.movement.speed + p.start.position.y + oppo.rally.side.change.count , data = stry_scale, nstates = 3, family=multinomial("identity"))
 ds3.fm2.3s <- fit(ds3.mod2.3s)
