...
#Modelling
Visual analysis has been used to select a number of new variables from the rallies data set. For the two hdden state model 'winner' is the response variable. For the three hidden state model 'winner.return.error' is the response variable. 
