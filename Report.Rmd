...
I then ran the three state models with the p.advantage as the second response variable. The reasoning for this is to observe the intercept of player advantage in different states. This may provide more insight into player shot intentions. 

At the zero values of the covariates, three clear states can be seen. However with repeated running of these models, the results are not repeatable.
