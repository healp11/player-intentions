...
I have seperated out the code which shapes the variables in the player data and creates the data files needed to run this report.
...
Here is a series of plots showin:
...
Some three state models and stepwise analysis have been commented out because of cuasing issues with the knit. The code can still be run in Rmarkdown by uncommenting. 
